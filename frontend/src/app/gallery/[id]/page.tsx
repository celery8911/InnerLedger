      ...
      <div className="relative p-6 lg:p-12 max-w-4xl mx-auto selection:bg-[#00E5FF]/30">
        <div className="min-h-[70vh] flex flex-col">
          <header className="flex justify-between items-start mb-10">
            <Link
              href="/gallery"
              className="w-11 h-11 rounded-full border border-white/10 flex items-center justify-center bg-white/5 hover:bg-white/10 transition-colors"
