  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-center p-6 relative overflow-hidden text-foreground selection:bg-primary/30">
      ...
      <nav className="absolute top-0 w-full p-6 flex justify-between items-center max-w-5xl z-50">
        <div className="text-base md:text-base font-semibold uppercase text-transparent bg-clip-text bg-gradient-to-r from-white via-primary/80 to-white drop-shadow-[0_0_18px_rgba(82,122,119,0.6)]">
      ...
      <div className="z-10 flex flex-col items-center text-center space-y-10 max-w-3xl">
        <div className="flex items-center gap-4 glass-pill px-6 py-2 rounded-full text-[10px] md:text-xs text-white/60 tracking-[0.2em] uppercase">
        ...
        <div className="flex flex-col sm:flex-row gap-6 pt-8">
          ...
          >
            <span className="tracking-[0.2em] uppercase text-xs">开始旅程</span>
            <ArrowRight
              size={16}
          ...
          <Link
            href="/journey"
            className="px-10 py-4 glass-pill text-white/70 rounded-full font-light hover:text-white hover:bg-white/10 transition-all tracking-[0.2em] uppercase text-xs"
          >
            探索广场
          </Link>
        </div>
